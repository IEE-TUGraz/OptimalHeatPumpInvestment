...
for index, scenario in scenarios.iterrows():
    ...
    df_heat_demand, df_el_price, df_cop_scalor, df_rpWeights = TimeSeriesAggregation.performe_TSA(df_heat_demand_full, df_el_price_full, df_cop_scalor_full, global_params["num_rep_periods"], global_params["hours_per_period"])
